...
NAME = 'vargan'
DESCRIPTION = 'Experimenting with variational inference in GANs',
MAINTAINER = 'Zigfried Hampel-Arias'
MAINTAINER_EMAIL = 'zhampel.github@gmail.com'
URL = 'https://github.com/zhampel/experiments-varGAN'
LICENSE = 'MIT'
...
about = {}
with io.open(os.path.join(here, 'vargan', '__version__.py'), encoding='utf-8') as f:
    exec(f.read(), about)
